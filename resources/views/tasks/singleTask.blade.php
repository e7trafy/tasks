<div class="media text-muted pt-3 border-bottom border-gray">
    ...
    <p class="media-body col-md-9 pb-3 mb-0 small lh-125 ">
        <strong class="d-block text-gray-dark">{{$task->user->name}}</strong>
        {{$task->description}}
    </p>

    <div class="col-md-3 float-left"><span
            class="d-block text-gray-dark">due date : <strong>{{date('d-m-Y', strtotime($task->due_date))}}</strong></span>
